const { validateRecurrence, validatePosition } = require('./src/validate.js')
...
console.debug('Part 1:', lines.filter(validateRecurrence).length)
console.debug('Part 2:', lines.filter(validatePosition).length)
